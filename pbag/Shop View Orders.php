...
<head>
	...
	<meta charset="UTF-8" />
	<meta name="keywords" content="P-Bagsauty Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	<script>
...
?>
					...
					<div class="nav_w3ls">
						<nav>
							<ul class="menu">
								...
								<li><a href="Shop Add Product.php" >Add Product</a></li>
								<li><a href="Shop View My Product.php">My Product</a></li>
								<li><a href="Shop View Orders.php" class="active">view Booking</a></li>
	...
	<!-- gallery -->
	<b><h2>VIEW CUSTOMER ORDERS</h2></b>
	<div class="gallery py-5" id="gallery">
		<div class="container py-lg-5">	
				...
				<?php    
					session_start();
					$uid=$_SESSION['sid'];
					$res=mysqli_query($conn,"SELECT customer_order.*, cust_reg.*,products.* FROM customer_order
INNER JOIN cust_reg ON customer_order.uid=cust_reg.cid inner join products on products.product_id=customer_order.pid where products.shid =$uid");
					...
					<div class='row' >
						...
						<div class='col-md-2' style='border-style: solid;'>$fname</div>
