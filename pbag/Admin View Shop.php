...
?>
							...
							<ul class="menu">
								...
								<li class="mx-lg-4 mx-md-3 my-md-0 my-2">
									...
									<ul>
										...
										<li><a href="Admin View Shop.php" class="active" class="drop-text">Shop</a></li>
	...
	<div class="gallery py-5" id="gallery">
		<div class="container py-lg-5">	
				...
				<div class="row" >
						<div class="col-md-2" width:50px; style="border-style: ridge;"><b>Club ID</b></div>
						...
						<div class="col-md-2" style="border-style: ridge;"><b>Registration No</b></div>
					</div>
				<?php 
					
					$res=mysqli_query($conn,"SELECT * from shop_reg where status = 'Registered'");
					...
					<div class='row' >
						...
						<div class='col-md-2' style='border-style: ridge;'>$email</div>
						<div class='col-md-2' style='border-style: ridge;'>$reg</div>
						<div class='col-md-2' style='border-style: ridge;'><a href='shop accept.php?id=$id'>Accept</a></div>
						<div class='col-md-2' style='border-style: ridge;'><a href='shop reject.php?id=$id'>Reject</a></div>
					</div>
				";
					}
				?>
