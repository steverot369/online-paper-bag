...
<body>
					...
					<li>
						<div class="container">
							<div class="w3ls_banner_txt">
								<p>Welcome to our</p>
								<h3 class="w3ls_pvt-title">P-BAG SHOPPING</h3>
					...
					<li>
						<div class="container">
							<div class="w3ls_banner_txt text-center mx-auto">
								...
								<h3 class="w3ls_pvt-title">Bike</h3>
								<a href="about.html" style="max-width: 150px;" class="btn button-style mt-sm-5 mt-4">Read More</a>
							</div>
						</div>
					</li>
					<li>
						<div class="container">
							<div class="w3ls_banner_txt text-right ml-auto">
								...
								<h3 class="w3ls_pvt-title">Trip</h3>
								<a href="about.html" style="max-width: 150px;" class="btn button-style mt-sm-5 mt-4">Read More</a>
							</div>
						</div>
					</li>
	...
	<div class="about py-5" id="about" >
		<div class="container py-xl-5 py-lg-3">
			...
			<p class="title-sub text-center mb-sm-5 mb-4">Experience the art of shopping</p>
			<div class="row about-bottom-w3l text-center pt-xl-5">
				<div class="col-md-6"  style="opacity: 0.0">
					<div class="about-grid-main">
						<img src="images/a1.png" alt="" class="img-fluid">
						<h4 class="my-3">Bike & Parts</h4>
				...
				<div class="col-md-6 about-grid mt-md-0 mt-4" style="opacity: 0.0">
					<div class="about-grid-main">
						<img src="images/a2.png" alt="" class="img-fluid">
						<h4 class="my-3">Club & Trip</h4>
						<p>Ut enim ad minim veniam, quis nostrud exercitation ullamco</p>
						<a href="about.html" class="button-w3ls mt-4"><span class="fa fa-hand-o-right mr-2" aria-hidden="true"></span>
							Read More
						</a>
