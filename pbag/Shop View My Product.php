...
?>
					...
					<div class="nav_w3ls">
						<nav>
							<ul class="menu">
								...
								<li><a href="Shop View My Product.php" class="active">My Product</a></li>
								<li><a href="Shop View Orders.php" >view Booking</a></li>
	...
	<div class="gallery py-5" id="gallery">
		<div class="container py-lg-5">	
				...
				<div class="row" >
						<div class="col-md-2" style="border-style: solid;"><b>Product ID</b></div>
						...
						<div class="col-md-2" style="border-style: solid;"><b>Stock</b></div>
					</div>
				<?php    
					session_start();
					$uid=$_SESSION['sid'];
					$res=mysqli_query($conn,"select * from products where shid = '$uid'");
	  				while($data=mysqli_fetch_assoc($res))
					{
						...
						echo "
					<div class='row' >
						<div class='col-md-2' style='border-style: solid;'>$id</div>
						...
						<div class='col-md-2' style='border-style: solid;'><a href='Shop Update Product.php?id=$id'>Update Stock</a></div>
						<div class='col-md-2' style='border-style: solid;'><a href='Shop Delete Product.php?id=$id'>Delete Product</a></div>
					</div>
				";
					}
				?>
