					...
					<div class="nav_w3ls">
						<nav>
							<ul class="menu">
								...
								<li><a href="Shop View Orders.php" >Booking</a></li>
						...
						if(isset($_REQUEST['ADD']))
					  	{
							...
							// $id=$_SESSION["iii"];
					 		#  $c=$_REQUEST['cat_id'];
							$qry="update products set quantity = '$st' where product_id = '$id' and shid = '$i'";
							// echo $qry;
					  		mysqli_query($conn,"update products set quantity = '$st' where product_id = '$id' and shid = '$i'");
