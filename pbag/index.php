		...
		<header>
			<div class="container-fluid">
				<div class="header d-md-flex justify-content-between align-items-center py-3 px-xl-5 px-lg-3 px-2">
					<!-- logo -->
					<div id="logo">
						<h1><a class="" href="index.html">P-Bags</a></h1>
					</div>
					<!-- //logo -->
					<!-- nav -->
					<div class="nav_w3ls">
						<nav>
							<ul class="menu">
								...
								<li class="mx-lg-4 mx-md-3 my-md-0 my-2">
									...
									<a href="#">Sign Up <span class="fa fa-angle-down" aria-hidden="true"></span></a>
									<input type="checkbox" id="drop-2" />
									<ul>
										<li><a href="Customer Registration.php" class="drop-text">Customer</a></li>
									
										<li><a href="Shop Registration.php" class="drop-text">Manufacture</a></li>
					...
					<li>
						<div class="container">
							<div class="w3ls_banner_txt">
								...
								<h3 class="w3ls_pvt-title">P-BAGS</h3>
								<a href="about.html" style="max-width: 150px;" class="btn button-style mt-sm-5 mt-4">Read More</a>
							</div>
						</div>
					</li>
					<li>
						<div class="container">
							<div class="w3ls_banner_txt text-right ml-auto">
								...
								<h3 class="w3ls_pvt-title">P-BAG</h3>
								<a href="about.html" style="max-width: 150px;" class="btn button-style mt-sm-5 mt-4">Read More</a>
							</div>
						</div>
					</li>
