	...
	<div class="navbar navbar-default navbar-fixed-top" id="topnav">
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="index.php" class="navbar-brand" style="color:#337ab7;" >Harleys Travelogue</a>
			</div>

			<ul class="nav navbar-nav">
				<li style="width:300px;left:10px;top:10px;"><input type="text" class="form-control" id="search" placeholder="Search here" name=""></li>
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<?php /*?><li><a href="Signin.php" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span>Sign In</a>
				...
				<li><a href="Customer Home.php">Back To Home</a></li>
				<li><a href="Customer View Cart.php">Go To Cart</a></li>
		...
		<div class="row">
			...
			<div class="row">
				...
				<div class="panel panel-info">
					...
					<div class="panel-footer">&copy; 2019 Harleys Travelogue.com</div>
				</div>
			</div>
			<div class="col-md-1"></div>
		</div>
...
<p> Brought To You By <a href="https://code-projects.org/">shyam</a></p>
</footer></div>
