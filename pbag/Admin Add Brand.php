							...
							<ul class="menu">
								...
								<li class="mx-lg-4 mx-md-3 my-md-0 my-2">
									...
									<ul>
										...
										<li><a href="Admin Add Category.php" class="drop-text">Category</a>
										</li>
										<li><a href="Admin Add Brand.php" class="active" class="drop-text">Brand</a></li>
									</ul>
								</li>
								<li class="mx-lg-4 mx-md-3 my-md-0 my-2">
									<!-- First Tier Drop Down -->
...
<input type="submit" value="ADD" name="ADD"/>
					 ...
					 #  $c=$_REQUEST['cat_id'];
					  mysqli_query($conn,"insert into brands(brand_title) values('$b')");
