...
<head>
	<title>Harleys Travelogue</title>
	<!-- Meta tag Keywords -->
...
?>
		...
		<header>
			<div class="container-fluid">
				<div class="header d-md-flex justify-content-between align-items-center py-3 px-xl-5 px-lg-3 px-2">
					<!-- logo -->
					<div id="logo">
						<h1><a class="" href="index.html">Harleys Travelogue</a></h1>
					</div>
					<!-- //logo -->
					<!-- nav -->
					<div class="nav_w3ls">
							...
							<ul class="menu">
								...
								<li class="mx-lg-4 mx-md-3 my-md-0 my-2">
									...
									<ul>
										...
										<li><a href="Admin Add Category.php"  class="drop-text">Category</a></li>
										<li><a href="Admin Add Brand.php"  class="drop-text">Brand</a></li>
									</ul>
								</li>
								<li class="mx-lg-4 mx-md-3 my-md-0 my-2">
									<!-- First Tier Drop Down -->
									...
									<a href="#">View <span class="fa fa-angle-down" aria-hidden="true"></span></a>
									<ul>
										<li><a href="Admin View Customers.php"  class="drop-text">Customer</a></li>
							
										<li><a href="Admin View Shop.php"  class="drop-text">Shop</a></li>
										<!-- <li><a href="Admin View Feedback.php"  class="active" class="drop-text">Feedback</a></li> -->
									</ul>
								</li>
	...
	<div class="gallery py-5" id="gallery">
		<div class="container py-lg-5">	
				...
				<div class="row" >
						<div class="col-md-2" style="border-style: solid;"><b>Feedback ID</b></div>
						<div class="col-md-2" style="border-style: solid;"><b>Feedback</b></div>
						<div class="col-md-2" style="border-style: solid;"><b>Posted On</b></div>
						<div class="col-md-2" style="border-style: solid;"><b>Customer</b></div>
						<div class="col-md-2" style="border-style: solid;"><b>Mobile</b></div>
						<div class="col-md-2" style="border-style: solid;"></div>
					</div>
				<?php 
					
					$res=mysqli_query($conn,"SELECT feedback.*, cust_reg.* FROM feedback INNER JOIN cust_reg");
	  				while($data=mysqli_fetch_assoc($res))
					{
						...
						echo "
					<div class='row' >
						<div class='col-md-2' style='border-style: solid;'>$fid</div>
						<div class='col-md-2' style='border-style: solid;'>$feedback</div>
						<div class='col-md-2' style='border-style: solid;'>$date</div>
						<div class='col-md-2' style='border-style: solid;'>$cname</div>
						<div class='col-md-2' style='border-style: solid;'>$mobile</div>
						<div class='col-md-2' style='border-style: solid;'><a href='Delete Feedback.php?id=$fid'>Delete message</a></div>
					</div>
				";
					}
				?>
			...
			<div class="row">
				<div class="col-lg-3 col-sm-6 agileinfo_footer_grid">
					...
					<div class="logo-2 mb-sm-4 mb-3">
						<h2><a href="index.html">Harleys Travelogue</a></h2>
					</div>
					<!-- //logo -->
	...
	<div class="newsletter-main text-center py-md-5 py-4">
		<div class="container">
			...
			<div class="w3agile_footer_copy mt-sm-5 mt-4">
				<p>© 2019 Harleys Travelogue. All rights reserved | Design by
					<a href="http://w3layouts.com/">Harleys Travelogue.</a>
				</p>
			</div>
			<!-- //copyright -->
		</div>
