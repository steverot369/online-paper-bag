...
?>
		...
		<header>
			<div class="container-fluid">
				<div class="header d-md-flex justify-content-between align-items-center py-3 px-xl-5 px-lg-3 px-2">
					<!-- logo -->
					<div id="logo">
						<h1><a class="" href="index.html">ADMIN HOME</a></h1>
					</div>
					<!-- //logo -->
					<!-- nav -->
					<div class="nav_w3ls">
						<nav>
							<ul class="menu">
								...
								<li class="mx-lg-4 mx-md-3 my-md-0 my-2">
									...
									<ul>
										<li><a href="Admin View Customers.php" class="active" class="drop-text">Customer</a></li>
						
										<li><a href="Admin View Shop.php"  class="drop-text">Shop</a></li>
										<!-- <li><a href="Admin View Feedback.php" class="drop-text">Feedback</a></li> -->
									</ul>
								</li>
	...
	<div class="gallery py-5" id="gallery">
		<div class="container py-lg-5">	
				...
				<div class="row" >
						<div class="col-md-2" width:50px; style="border-style: ridge;"><b>Customer ID</b></div>
						<div class="col-md-2" style="border-style: ridge;"><b>Name</b></div>
						<div class="col-md-2" style="border-style: ridge;"><b>Address</b></div>
						<div class="col-md-2" style="border-style: ridge;"><b>Location</b></div>
						<div class="col-md-2" style="border-style: ridge;"><b>District</b></div>
						
						<div class="col-md-2" style="border-style: ridge;"><b>Email</b></div>
						<div class="col-md-2" style="border-style: ridge;"><b>Mobile</b></div>
					</div>
				<?php 
					
					$res=mysqli_query($conn,"SELECT * from cust_reg");
	  				while($data=mysqli_fetch_assoc($res))
					{
						...
						echo "
					<div class='row' >
						<div class='col-md-2' style='border-style: ridge;'>$id</div>
						<div class='col-md-2' style='border-style: ridge;'>$name</div>
						<div class='col-md-2' style='border-style: ridge;'>$address</div>
						<div class='col-md-2' style='border-style: ridge;'>$location</div>
						
						<div class='col-md-2' style='border-style: ridge;'>$district</div>
						<div class='col-md-2'  width:100px; style='border-style: ridge;'>$email</div>
						<div class='col-md-2' style='border-style: ridge;'>$mobile</div>
					</div>
				";
					}
				?>
